...
(function ($) {
    ...
    window.wijinputcore = {
        ...
        _create: function () {
            ...
            this.element.wrap("<div class=''><span ></span></div>");
            this.element.addClass('').attr({ 'role': 'textbox', 'aria-multiline': false });
            this.wrapper = this.element.parent();
            this.outerDiv = this.wrapper.parent();

            if (this.options.showTrigger) {
                this.triggerBtn = $("<div class=''><span class='ui-icon ui-icon-triangle-1-s'></span></div>")
            ...
            if (this.options.showSpinner) {
                this.spinner = $("<div class=''></div>");
                this.spinUp = $("<div class=''><span class='ui-icon ui-icon-triangle-1-n'></span></div>").attr('role', 'button');
                this.spinDown = $("<div class=''><span class='ui-icon ui-icon-triangle-1-s'></span></div>").attr('role', 'button');
                if (!this.options.showTrigger) {
