	...
	$.fn.dataTableExt.oPagination = {
		...
		"full_numbers": {
			...
			"fnInit": function ( oSettings, fnCallbackDraw )
			{
				...
				nFirst.className = "btn btn-default";
				nPrevious.className = "btn btn-default";
				nNext.className="btn btn-default";
				nLast.className = "btn btn-default";
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				for ( var i=iStartButton ; i<=iEndButton ; i++ )
				{
					if ( iCurrentPage != i )
					{
						sList += '<span class="btn btn-default">'+i+'</span>';
					}
					else
					{
						sList += '<span class="btn btn-info">'+i+'</span>';
					}
				}
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sInfo": "Mostrando del _START_ al _END_ de _TOTAL_ filas",
				"sInfoEmpty": "Mostrando del 0 al 0 de 0 filas",
			 ...
			 * Scope:    jQuery.dataTable.classSettings
			 */
			this.iDisplayLength = 10; // Muestra 10 elementos a la vez por defecto
		...
		function _fnAddOptionsHtml ( oSettings )
		{
			...
			nWrapper.className = "dataTables-wrapper";
			if ( oSettings.sTableId !== '' )
			{
				nWrapper.setAttribute( 'id', oSettings.sTableId+'-wrapper' );
			}
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			if ( oSettings.sTableId !== '' )
			{
				nFilter.setAttribute( 'id', oSettings.sTableId+'-filter' );
			}
			nFilter.className = "dataTables-filter col-lg-4";
			nFilter.innerHTML = '<div class="input-group row"><span class="input-group-addon">' + oSettings.oLanguage.sSearch+' </span><input class="form-control" type="text" value="'+
				oSettings.oPreviousSearch.sSearch.replace('"','&quot;')+'" /></div>';
		...
		function _fnFeatureHtmlInfo ( oSettings )
		{
			...
			if ( oSettings.sTableId !== '' )
			{
				oSettings.nInfo.setAttribute( 'id', oSettings.sTableId+'-info' );
			}
			oSettings.nInfo.className = "dataTables-info";
			return nInfo;
		}
		...
		function _fnFeatureHtmlPaginate ( oSettings )
		{
			...
			nPaginate.className = "dataTables-paginate btn-group";
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sName = (oSettings.sTableId === "") ? "" : 'name="'+oSettings.sTableId+'-length"';
			var sStdMenu = 
				'<div class="input-group row"><span class="input-group-addon">Filas a mostrar:</span>' +
                    '<select class="form-control" size="1" '+sName+'>'+
			...
			if ( oSettings.sTableId !== '' )
			{
				nLength.setAttribute( 'id', oSettings.sTableId+'-length' );
			}
			nLength.className = "dataTables-length col-lg-3";
