...
use App\Repository\IngresoGastoTrabajadorRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Bundle\FrameworkBundle\Controller\AbstractController;

/**
 * @ORM\Entity(repositoryClass=IngresoGastoTrabajadorRepository::class)
 */
class IngresoGastoTrabajador
{
    /**
     * @ORM\Id()
    ...
    public function setTrabajador(?Usuario $trabajador): self
    {
